...
//
// mbr.Table implements the Table interface in github.com/cusspvz/go-diskfs/partition
//
// Normally, the best way to interact with a disk is to use the github.com/cusspvz/go-diskfs package,
